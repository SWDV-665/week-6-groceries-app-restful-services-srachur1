...
var GroceriesServiceProvider = /** @class */ (function () {
    ...
    GroceriesServiceProvider.prototype.removeItem = function (item) {
        var _this = this;
        console.log(item);
        this.http.delete(this.baseURL + '/api/groceries/' + item._id).subscribe(function (res) {
            _this.items = res;
    ...
    GroceriesServiceProvider.prototype.editItem = function (item, index) {
        var _this = this;
        var id = item._id;
        this.http.put(this.baseURL + '/api/groceries/' + id, item).subscribe(function (res) {
            _this.items = res;
            _this.dataChangeSubject.next(true);
        });
    };
...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\tabs\tabs.html"*/
        }),
...
var AboutPage = /** @class */ (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\about\about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card>\n    <ion-card-content>\n        <ion-item>Name: Satya Rachur</ion-item>\n      <ion-item>Student ID: 0910340</ion-item>\n    </ion-card-content>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\about\about.html"*/
        }),
...
var ContactPage = /** @class */ (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\contact\contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      @ionicframework\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\contact\contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.shareItem = function (item, index) {
        ...
        var subject = "Share via Groceries app";
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\home\home.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title>{{title}}</ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <h3 class="no-item" text-center *ngIf="items.length === 0">\n        No item available on the list!\n    </h3>\n    <ion-list>\n        <ion-item-sliding *ngFor="let item of items; let i = index;">\n            <ion-item>\n                <h2>{{item.name}}</h2>\n                <p>{{item.quantity}}</p>\n            </ion-item>\n            <ion-item-options>\n                <button (click)="editItem(item, i)" ion-button color="primary" icon-start>\n          <ion-icon name="create"></ion-icon>\n          Edit\n        </button>\n                <button (click)="shareItem(item, i)" ion-button color="light" icon-start>\n          <ion-icon name="share"></ion-icon>\n          Share\n        </button>\n                <button (click)="removeItem(item, i)" ion-button color="secondary" icon-start>\n          <ion-icon name="trash"></ion-icon>\n          Delete\n        </button>\n            </ion-item-options>\n        </ion-item-sliding>`\n    </ion-list>\n    <ion-fab bottom right>\n        <button (click)="addItem()" ion-fab mini>\n      <ion-icon name="add"></ion-icon>\n    </button>\n    </ion-fab>\n</ion-content>'/*ion-inline-end:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\pages\home\home.html"*/
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\Users\satya\Desktop\swdv665\week-6-groceries-app-restful-services-pgorripati1-master\week-6-groceries-app-restful-services-pgorripati1-master\groceries\src\app\app.html"*/
        }),
